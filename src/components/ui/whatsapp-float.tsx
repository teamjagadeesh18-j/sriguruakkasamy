...
export function WhatsAppFloat() {
  const message = encodeURIComponent("Hello! I am reaching out from Sri Guru Akkasamy Velammal School website to enquire about admissions.");
  const whatsappUrl = "https://wa.me/919840476701?text=" + message;
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-2 group">
      ...
      <a
        ...
        className="relative w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300"
      >
